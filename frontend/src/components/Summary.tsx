...
const Summary = () => {
  ...
  return (
    <div>
      <div className='border-b flex justify-between mt-8'>
        <div>
          <div className='flex gap-2'>
            <img className='w-8' src="images/1.png" alt="1" />
            <span className=' font-semibold text-gray-600'>미라클 레터</span>
          </div>
          <p className='mt-2 mb-4 text-2xl font-bold'>asadnkfsadnfksadn</p>
        </div>
        <span className='text-sm font-bold text-gray-400'>2024년 02월 07일 수요일</span>
      </div>
