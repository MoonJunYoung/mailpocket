...
const KakaoLogin = () => {
  const kakaoProps = {
    ...
    socialLoginUrl:
      "https://kauth.kakao.com/oauth/authorize?client_id=f898615d1b15529653e04549bd5203b7&redirect_uri=https://test.mailpocket.site/kakao-oauth-redirect&response_type=code",
    type: "kakao",
...
const NaverLogin = () => {
  const naverProps = {
    ...
    socialLoginUrl:
      "https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=Q9vH3BUxoFpZea90R2g3&redirect_uri=https://test.mailpocket.site/naver-oauth-redirect",
    type: "naver",
...
const GoogleLogin = () => {
  const googleProps = {
    ...
    socialLoginUrl:
      "https://accounts.google.com/o/oauth2/v2/auth?response_type=token&scope=https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile&client_id=398680694432-j5tr9e2uk37g7shjipa1umr40r7gsltg.apps.googleusercontent.com&redirect_uri=https://test.mailpocket.site/google-oauth-redirect",
    type: "google",
